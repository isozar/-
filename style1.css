...
#ArchiveList select{width:100%;padding:10px;margin-bottom:5px;border:1px solid rgba(201,201,201,0.52);font-size:13px;font-family:droid-sans}


/* Arlina Template Wrapper */
.maxiwrap {max-width:970px;margin:0 auto;}
#wrapper{background:#fff;display:block;position:relative;overflow:hidden;max-width:970px;margin:0 auto;padding:0;border-right:1px solid rgba(0,0,0,0.1);border-left:1px solid rgba(0,0,0,0.1)}
...
#header .title{font-size:180%;margin:5px 0 0 0;padding:0;display:inline-block;width:100%;font-weight:400}
...
/* القائمة */
#simplify-two{font-size:0;white-space:nowrap;padding:0;margin:0 auto;float:right}
...
#search-me input#search-boxs1[type=&quot;text&quot;]{background:#3d548f;height:36px;line-height:35px;margin:0;padding:0 10px;width:100%;border:none;color:#cbd1e1!important;font-family:tahoma;letter-spacing:1px;}
#search-me input#search-button1[type=&quot;submit&quot;]{font-family:FontAwesome;font-size:15px;background:transparent;color:#fff;height:60px;line-height:60px;margin:0;padding:0 15px;border:none;outline:none;font-weight:normal!important;transition:all 0.25s;position:absolute;left:0;top:0;z-index:2;cursor:pointer;}
...
#sidebar-wrapper h2,#sidebar-wrapper h3,#sidebar-wrapper h4{position:relative;overflow:hidden;margin:0;font-size:14px;vertical-align:middle;padding:0 0 10px 0;border-bottom:1px solid rgba(0,0,0,.1);}
#sidebar-wrapper h2 span,#sidebar-wrapper h3 span,#sidebar-wrapper h4 span{display:inline-block;vertical-align:middle}
#sidebar-wrapper h2:after,#sidebar-wrapper h3:after,#sidebar-wrapper h4:after{content:&#39;&#39;;display:inline-block;position:absolute;height:15px;top:0;margin:8px 10px 3px 0;width:100%;background:url(https://4.bp.blogspot.com/-R2WTW6O9E1o/VX7dqIGT1eI/AAAAAAAACc4/pyvQDMMLX3E/s1600/repeat-bg.png)repeat;opacity:.9;}
...
/* التسميات */
.droplabeldo select{outline:none;cursor:pointer;transition:all .6s ease-out;font-family:inherit;}
...
.dropdown-select{color:#000;position:relative;width:100%;margin:0;padding:6px 8px 0 10px;height:40px;line-height:20px;font-size:13px;border:1px solid rgba(0,0,0,0.1);-webkit-appearance:none;transition:border-color ease-in-out .15s,box-shadow ease-in-out .15s}
.droplabeldo select:hover{border-color:rgba(0,0,0,.34);}
.droplabeldo select:focus{outline:none;cursor:pointer;border-color:#66afe9;box-shadow:inset 0 1px 1px rgba(0,0,0,.075),0 0 8px rgba(102,175,233,0.6);}
.dropdown-select&gt;option{background:#fafafa;position:relative;display:block;margin:3px;text-shadow:none;outline:0;border:0;cursor:pointer}
/* Arlina Footer Wrapper */
#footer-wrapper{background:#2f303f;color:#bdc3c7;text-align:center;padding:20px 0 0 0;margin:auto;border-top:5px solid #2c4584}
.simplifymed a{display:inline-block;text-align:center;margin-top:10px;margin-left:5px;color:#fff;border-radius:100%;opacity:.9;}
...
.footer-column h3:after{content:&#39;&#39;;display:inline-block;position:absolute;height:15px;top:0;margin:8px 10px 3px 0;width:100%;background:url(https://4.bp.blogspot.com/-R2WTW6O9E1o/VX7dqIGT1eI/AAAAAAAACc4/pyvQDMMLX3E/s1600/repeat-bg.png)repeat;opacity:.7;}
.footer-menu{float:right;width:31%;margin:0 0 0 20px}
.footer-menu p.footer2{margin:5px auto}
.footer-menu ul{margin:0}
.footer-menu ul li{list-style-type:square;margin:0 20px 0 0}
...
#PopularPosts1 .item-thumbnail{margin:0 0 0 10px;overflow:hidden;z-index:2;display:block;position:relative;border-radius:0;width:90px;height:62px;float:right}
...
#search-boxs{width:96%;float:right;padding-left:0;margin:0 2%}
...
#simplify-two ul{background:#fff;position:absolute;top:100%;right:0;z-index:3;height:auto;float:none;display:none}
#simplify-two ul &gt; li{float:none}
#simplify-two ul.menus{width:100%;position:static;padding-right:20px}
#simplify-two li{display:block;float:none;width:auto}
#simplify-two li a:hover,#simplify-two ul.menus a:hover{background:#24376a;color:#fff;}
#simplify-two a{background:#2c4584;padding:12px;height:initial;line-height:initial;color:#fff;border:0;margin:0}
#simplify-two ul &gt; li a i{color:rgba(255,255,255,.5);float:left}
...
#simplify-two li ul {background:#2c4584;padding:0;position:relative;width:100%;right:initial;box-shadow:none;}
#simplify-two li:hover ul.menus,#simplify-two li:hover &gt; ul{right:initial}
#simplify-two a i {float:left;}
